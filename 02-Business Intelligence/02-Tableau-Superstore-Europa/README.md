...
![Storytelling](https://img.shields.io/badge/Framework-3C_Storytelling-purple)
![Status](https://img.shields.io/badge/Status-Completed-success)

## 📌 Panoramica del Progetto
Progetto realizzato durante il **Master in Data Analytics di ProfessionAI**, come capstone del modulo su Tableau e Data Storytelling. Il progetto lavora sul dataset pubblico *Global Superstore* (segmento Europa), simulando la necessità di sostituire la reportistica statica con sistemi dinamici per monitorare le operazioni europee e definire una strategia data-driven di riallocazione del budget marketing basata sul reale potenziale e margine dei prodotti.

**Dataset:** Global Superstore (dataset pubblico ampiamente usato per esercitazioni di BI)

🔗 **[Esplora il progetto interattivo su Tableau Public](https://public.tableau.com/app/profile/alessandro.gravagna/viz/Progettotableaumaster/Storia1)**
...
* **Data storytelling (framework 3C):** strutturazione visiva in formato Tableau Story basata sulla regola delle 3C (Contesto, Conflitto, Conclusione) per guidare a decisioni rapide.
...
## 📖 Struttura del Tableau Story (Framework 3C)
...
- **Visual Analytics:** Tableau Stories, dashboard layout responsive, dashboard actions (highlight & filter).
